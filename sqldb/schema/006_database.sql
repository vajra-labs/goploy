...
CREATE TABLE "postgres_dbs" (
	...
	"description" TEXT,
	"docker_image" TEXT NOT NULL DEFAULT 'postgres:16',
...
CREATE TABLE "mysql_dbs" (
	...
	"app_name" TEXT NOT NULL UNIQUE,
	"description" TEXT,
	"docker_image" TEXT NOT NULL DEFAULT 'mysql:8',
	"database_name" TEXT NOT NULL,
	"database_user" TEXT NOT NULL,
	"database_password" TEXT NOT NULL,
...
CREATE TABLE "mariadb_dbs" (
	...
	"app_name" TEXT NOT NULL UNIQUE,
	"description" TEXT,
	"docker_image" TEXT NOT NULL DEFAULT 'mariadb:11',
	"database_name" TEXT NOT NULL,
	"database_user" TEXT NOT NULL,
	"database_password" TEXT NOT NULL,
	"database_root_password" TEXT NOT NULL,
...
CREATE TABLE "redis_dbs" (
	...
	"app_name" TEXT NOT NULL UNIQUE,
	"description" TEXT,
	"docker_image" TEXT NOT NULL DEFAULT 'redis:7',
	"database_password" TEXT NOT NULL,
	"external_port" INTEGER,
	"command" TEXT,
	"args" TEXT,	-- JSON array

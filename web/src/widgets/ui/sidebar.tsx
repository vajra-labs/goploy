...
import {Input} from '#/widgets/ui/input.tsx';
import {Separator} from '#/widgets/ui/separator.tsx';
import {
	Sheet,
	SheetContent,
	SheetDescription,
	SheetHeader,
	SheetTitle,
} from '#/widgets/ui/sheet.tsx';
import {Skeleton} from '#/widgets/ui/skeleton.tsx';
import {
	Tooltip,
	TooltipContent,
	TooltipTrigger,
} from '#/widgets/ui/tooltip.tsx';
...
function SidebarContent({
	...
	return (
		<div
			...
			className={cn(
				'no-scrollbar flex min-h-0 flex-1 flex-col gap-2 overflow-x-hidden overflow-y-auto',
				className,
			)}
			{...props}
		/>
